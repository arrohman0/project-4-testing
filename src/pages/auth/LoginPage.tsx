    ...
    <div className="flex min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <div className="hidden lg:block relative w-0 flex-1 bg-primary-700">
        <div className="absolute inset-0 flex flex-col justify-center p-12 text-white">
          <h2 className="text-4xl font-bold mb-6">Welcome to ProConnect</h2>
          <p className="text-xl mb-8">Connect with professionals, share knowledge, and grow your career.</p>
          <ul className="space-y-4">
            ...
            <li className="flex items-center">
              ...
              Find and share learning opportunities
            </li>
          </ul>
        </div>
      </div>
